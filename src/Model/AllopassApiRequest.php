...
use AllopassApiKit\Exception\AllopassApiMissingCompressionFeatureException;
use AllopassApiKit\Exception\AllopassApiMissingHashFeatureException;
use AllopassApiKit\Exception\AllopassApiMissingNetworkFeatureException;
use AllopassApiKit\Exception\AllopassApiUnavailableRessourceException;
...
abstract class AllopassApiRequest
{
     ...
     *
     * @param string $body The gzipped HTTP body
     *
     ...
     *
     * @param string $body The deflated HTTP body
     *
     ...
     *
     * @param string $body The chunked HTTP body
     *
